...
pub mod autoloads {
    pub fn global_rust_autoload() -> godot::obj::Gd<crate::RustAutoload> {
        godot::tools::get_autoload_by_name("GlobalRustAutoload")
    }

    pub fn renamed_rust_autoload() -> godot::obj::Gd<crate::RenamedRustAutoload> {
        godot::tools::get_autoload_by_name("RenamedRustAutoload")
    }
}
